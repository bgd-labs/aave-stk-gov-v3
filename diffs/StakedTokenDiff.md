...
@@ -422,30 +1808,6 @@ interface IAaveDistributionManager {
...
-
 interface IStakedTokenV2 {
   struct CooldownSnapshot {
     uint40 timestamp;
@@ -511,393 +1873,460 @@ interface IStakedTokenV2 {
   ) external;
 }
...
+  }
 ...
 /**
@@ -1174,407 +2603,278 @@ contract AaveDistributionManager {
   }
 }
...
+  function _afterTokenTransfer(address from, address to, uint256 amount) internal virtual {}
 ...
 /**
@@ -1584,9 +2884,11 @@ abstract contract GovernancePowerWithSnapshot is GovernancePowerDelegationERC20
  */
...
@@ -1603,18 +2905,8 @@ abstract contract StakedTokenV2 is
...
@@ -1628,13 +2920,27 @@ abstract contract StakedTokenV2 is
...
@@ -1673,78 +2979,17 @@ abstract contract StakedTokenV2 is
     //solium-disable-next-line
     require(block.timestamp <= deadline, 'INVALID_EXPIRATION');
...
@@ -1774,34 +3019,6 @@ abstract contract StakedTokenV2 is
...
@@ -1815,6 +3032,24 @@ interface IStakedTokenV3 is IStakedTokenV2 {
...
@@ -3194,15 +4429,34 @@ library SafeCast {
   }
 }
...
@@ -3215,7 +4469,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
...
@@ -3268,7 +4522,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
    * @return The revision
    */
...
+    return 4;
   ...
   /**
@@ -3282,21 +4536,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
   /**
...
+  function initialize() external virtual initializer {}
   ...
   function _initialize(
     address slashingAdmin,
@@ -3340,6 +4580,19 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
...
@@ -3363,7 +4616,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
...
+    _redeem(msg.sender, to, amount.toUint104());
   ...
   /// @inheritdoc IStakedTokenV3
@@ -3372,7 +4625,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
     address to,
     uint256 amount
...
+    _redeem(from, to, amount.toUint104());
   ...
   /// @inheritdoc IStakedTokenV2
@@ -3399,7 +4652,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
...
+    _redeem(msg.sender, to, redeemAmount.toUint104());
   ...
   /// @inheritdoc IStakedTokenV3
@@ -3410,7 +4663,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
     uint256 redeemAmount
   ) external override onlyClaimHelper {
...
+    _redeem(from, to, redeemAmount.toUint104());
   ...
   /// @inheritdoc IStakedTokenV3
@@ -3584,7 +4837,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
...
@@ -3595,13 +4848,13 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
...
+        (block.timestamp >= cooldownSnapshot.timestamp + _cooldownSeconds),
       ...
       require(
@@ -3620,7 +4873,7 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
...
@@ -3675,11 +4928,57 @@ contract StakedTokenV3 is StakedTokenV2, IStakedTokenV3, RoleManager, IAaveDistr
