```diff
diff --git a/flattened/current.sol b/flattened/new.sol
index 12d5367..f5b6818 100644
--- a/flattened/current.sol
+++ b/flattened/new.sol
@@ -1,7 +1,7 @@
...
@@ -4087,34 +5482,6 @@ interface IGhoVariableDebtTokenTransferHook {
 }
...
@@ -4136,36 +5503,6 @@ interface IStakedAaveV3 is IStakedTokenV3 {
     address to,
     uint256 amount
...
-  ) external;
 ...
 /**
@@ -4176,15 +5513,13 @@ interface IERC20WithPermit is IERC20 {
...
+    return 6;
   ...
   constructor(
@@ -4211,33 +5546,7 @@ contract StakedAaveV3 is StakedTokenV3, IStakedAaveV3 {
   /**
    * @dev Called by the proxy contract
    */
-  function initialize(
...
@@ -4256,160 +5565,77 @@ contract StakedAaveV3 is StakedTokenV3, IStakedAaveV3 {
